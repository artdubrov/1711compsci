...
int main()
{
    ...
    while (1)
    {
        ...
        case 'c':
            ...
            printf("The highest blood iron level is %.2f\n", highest);
            return 0;
            break;
        ...
        case 'd':
            ...
            printf("The lowest blood iron level is %.2f\n", lowest);
            return 0;
            break;
        ...
        case 'e':
            ...
            printf("Enter the month you require in the correct format\n");
            scanf("%s", &required_month);
            //16-SEP-2023
            for(int i = 0; i < counter; i++)
            {
                month_found *strstr(*daily_readings[i].date, *required_month);
                printf("%ls\n", &month_found);
            }
            return 0;
            break;
